...
The $S_0$ mode is significantly more sensitive to changes in hole size than the $A_1$ or $S_1$ modes. The large in-plane displacement of the $S_0$ mode makes it very sensitive to defects at any depth (such as holes), whereas the $A_1$ and $S_1$ modes exhibit a lower sensitivity due to their middle thickness nodes.  
