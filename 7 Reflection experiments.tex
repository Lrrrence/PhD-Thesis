...
The $S_0$ mode is significantly more sensitive to changes in hole size than the $A_1$ or $S_1$ modes. This may be advantageous in differentiating between different hole sizes on an NGV, where the holes along the leading edge of the vane may use a different geometry than the rest of the holes.