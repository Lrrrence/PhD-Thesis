...
\begin{figure}[p]
    ...
    \caption{Energy velocity dispersion curves for Inconel 718 with TBC.}\label{fig:inconeldispTBCgroup}
\end{figure}
...
\section{COMSOL simulations of wave propagation through Inconel 718 with TBC applied}
