...
%
\begin{equation}
    \alpha = 1.243109{\times}10^{-5}+5.050772{\times}10^{-8}\times T^1-5.806556{\times}10^{-11}\times T^2+3.014305{\times}10^{-14} \times T^3
\end{equation}
%
Where $T$ is temperature in Kelvin, the equation is valid from 230 K to 900 K. \hl{REF FROM COMSOL HERE}.
...
The change in Young's modulus with temperature in Aluminium is close to linear, as represented by the Equation~\cite{Hopkins2012}: 
%
\begin{equation}
