...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=.7\textwidth]{./figures/SAW resonator.png}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=.7\textwidth]{./figures/wedge.eps}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=.7\textwidth]{./figures/hertzian.eps}
...
\section{The effect of temperature on wave propagation in aluminium}\label{effectoftemponwaveprop}
