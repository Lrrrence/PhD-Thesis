...
The response measured at the central excitation point for models with varying numbers of holes is shown in \cref{fig:3D_S0_Input} for $S_0$, and \cref{fig:3D_A0_Input} for $A_0$. 

The reflection amplitude of $A_0$ is significantly larger than that of $S_0$. There is a strong receiver edge reflection for $A_0$, but not $S_0$. The reflection amplitude of $A_0$ is substantially larger with three holes over one. There is a greatly reduced receiver edge reflection amplitude when three holes are introduced. Interactions between reflections can be seen in the response, as two distinct wave packets are present.
...
\begin{figure}[p]
    ...
    \caption{Reflected reponse of $S_0$ at 1 MHz with a varying number of holes.}\label{fig:3D_S0_Input}
\end{figure}

\begin{figure}[p]
    \centering
    \includegraphics[width=\textwidth]{./figures/3D_A0_input.eps}
    \caption{Reflected reponse of $A_0$ at 1.4 MHz with a varying number of holes.}\label{fig:3D_A0_Input}
\end{figure}
...
\begin{figure}[p]
    ...
    \caption{Transmitted response of $S_0$ at 1 MHz with a varying number of holes.}\label{fig:3D_S0_Output}
\end{figure}

\begin{figure}[p]
    \centering
    \includegraphics[width=\textwidth]{./figures/3D_A0_output.eps}
    \caption{Transmitted response of $A_0$ at 1.4 MHz with a varying number of holes.}\label{fig:3D_A0_Output}
\end{figure}
