...
\begin{figure}[p]
    \centering
    \includegraphics[width=0.8\textwidth]{./figures/2DFFT-A0-1.4MHz-Ydisp.eps}
...
The number and size of holes across the propagation path have an effect on the stiffness of the material, which results in a reduction in wave velocity.   
