...
The results of these studies will determine the most suitable Lamb wave mode (or group of modes) for temperature monitoring of nozzle guide vanes. 

Further research is required to determine the most suitable transducer configuration for implementing an ultrasonic temperature monitoring system, as well as evaluating the effect of the complex curved geometry on wave propagation. 
