...
\begin{itemize}
    ...
    \item Journal paper ``Modelling and Validation of a Guided Acoustic Wave Temperature Monitoring System'' published to \href{https://www.mdpi.com/1424-8220/21/21/7390}{MDPI Sensors Special Issue ``Sensors for Severe Environments''}.
\end{itemize}
