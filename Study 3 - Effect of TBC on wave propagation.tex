...
\begin{figure}[p]
    \centering
    \includegraphics[width=0.9\textwidth]{./figures/pureincvsTBC20c.eps}
...
\begin{figure}[p]
    \centering
    \includegraphics[width=0.9\textwidth]{./figures/TBC_E.eps}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=.9\textwidth]{./figures/2DFFT-B1-0.8MHz-Ydisp.eps}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.9\textwidth]{./figures/IncTBCwaveprop2temp.eps}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.9\textwidth]{./figures/B1_comVpred.eps}
