\chapter{Study 1: Temperature sensitivity of guided waves}\label{chapter:tempsens}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=.8\textwidth]{./figures/Exp_S1_20c-100c.eps}
...
\section{Simulation study} \label{simstudymain}

The multi-physics simulation package COMSOL has been used to simulate potential temperature monitoring systems, investigating the effect of temperature on Lamb wave propagation.
...
\begin{figure}[h]
    \centering
    \includegraphics[width=.8\textwidth]{./figures/COMSOL_S0_20c-100c.eps}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=.8\textwidth]{./figures/2DFFT-S0-1MHz-Ydisp.eps}
    \caption{2D-FFT of $S_0$ excitation in 1 mm thick Aluminium at 20\si{\degreeCelsius}.}\label{fig:2DFFT-S0-Alu}
\end{figure}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=.8\textwidth]{./figures/COMSOL_A1_20c-100c.eps}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=.8\textwidth]{./figures/2DFFT-A1-1MHz-Ydisp.eps}
    \caption{2D-FFT of $A_1$ excitation in 2.5 mm thick Aluminium at 20\si{\degreeCelsius}.}\label{fig:2DFFT-A1-Alu}
\end{figure}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=.8\textwidth]{./figures/COMSOL_S1_20c-100c.eps}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=.8\textwidth]{./figures/2DFFT-S1-1MHz-Ydisp.eps}
    \caption{2D-FFT of $S_1$ excitation in 4 mm thick Aluminium at 20\si{\degreeCelsius}.}\label{fig:2DFFT-S1-Alu}
\end{figure}
...
\clearpage
\subsection{Inconel 718 simulation}
