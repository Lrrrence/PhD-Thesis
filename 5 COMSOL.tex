...
\begin{table}[h]
    ...
    \begin{tabular}{llllll}
        ...
        \midrule
        Top coat  & ZrO2-8 wt\% Y2O3 (8YSZ) & 48  & 0.1  & 5770~\cite{Zhang2012} & 200  \\
        TGO       & $\alpha$-Al2O3                & 400 & 0.23 & 3987~\cite{Bodisova2006}  & 10   \\
...
\begin{figure}[p]
    \raggedright
        \begin{subfigure}[c]{0.45\textwidth}
            ...
            \caption{$B_0$ Displacement -- 1 MHz-mm}\label{fig:B0}
        \end{subfigure}
        \hfill
        \begin{subfigure}[c]{0.45\textwidth}
            \centering
            \includegraphics[width=1\textwidth]{./figures/B1.eps}
            \caption{$B_1$ Displacement -- 1 MHz-mm}\label{fig:B1}
        \end{subfigure}
        \vskip\baselineskip
        \begin{subfigure}[c]{0.45\textwidth}
            \centering
            \includegraphics[width=1\textwidth]{./figures/B2.eps}
            \caption{$B_2$ Displacement -- 2.4 MHz-mm}\label{fig:B2}
        \end{subfigure}
        \hfill
        \begin{subfigure}[c]{0.45\textwidth}
            \centering
            \includegraphics[width=1\textwidth]{./figures/B3.eps}
            \caption{$B_3$ Displacement -- 2.4 MHz-mm}\label{fig:B3}
        \end{subfigure}
        \vskip\baselineskip
        \begin{subfigure}[c]{0.65\textwidth}
            \centering
            \includegraphics[width=1\textwidth]{./figures/B5.eps}
            \caption{$B_5$ Displacement -- 4.4 MHz-mm}\label{fig:B5}
        \end{subfigure}
    \caption{Through thickness displacement profiles for Inconel 718 with TBC applied.}\label{fig:inconelTBCdisplacement}
\end{figure}

\subsection{COMSOL simulations of wave propagation through Inconel 718 with TBC applied}

Three wave modes with clear peaks in group velocity were targeted, to be excited with a wedge transducer. $B_1$ at 1~MHz-mm, $B_3$ at 2.4~MHz-mm, and $B_5$ at 4.4~MHz-mm. These frequencies products correspond to peaks in the group velocity dispersion curves, where velocity is at a maximum for these modes. The use of wedge transducers further isolates each mode. 
